...
import TVMC from "@/top/TVMC";
import TVPiece1MC from "@/top/TVPiece1MC";
import TVPiece2MC from "@/top/TVPiece2MC";
import TVPiece3MC from "@/top/TVPiece3MC";
import TVShardsMC from "@/top/TVShardsMC";
...
export default class TV extends LevelItem {
    ...
    public createBody(param1: Special) {
        ...
        _loc9_.SetAsBox(27.5 / this.m_physScale, 20 / this.m_physScale);
        _loc8_.position.Set(
    ...
    private shatter() {
        ...
        _loc14_.vertices[2] = new b2Vec2(
            -26 / this.m_physScale,
            20 / this.m_physScale,
        );
        _loc14_.vertices[1] = new b2Vec2(0, 20 / this.m_physScale);
        _loc14_.vertices[0] = new b2Vec2(
            -26 / this.m_physScale,
            -18 / this.m_physScale,
        );
