...
@boundClass
export default class TargetActionPrisJoint extends LevelItem {
    protected _refSprite: RefSprite;
    protected _joint: b2PrismaticJoint;
        ...
        switch (this._action) {
            ...
            case "change limits":
                if (this._joint) {
                    ...
                    _loc1_ = this._properties[0] / this.m_physScale;
                    _loc2_ = this._properties[1] / this.m_physScale;
    ...
    public get joint(): b2PrismaticJoint {
        return this._joint;
    }

    public set joint(param1: b2PrismaticJoint) {
        this._joint = param1;
    }
