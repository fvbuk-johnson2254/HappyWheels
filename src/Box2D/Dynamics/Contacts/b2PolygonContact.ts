...
export default class b2PolygonContact extends b2Contact {
    ...
    public override Evaluate(param1: b2ContactListener) {
        ...
        b2Collision.b2CollidePolygons(
            ...
            _loc5_.m_xf,
            this.m_shape2 as b2PolygonShape,
            _loc6_.m_xf,
        );
        var _loc9_: any[] = [false, false];
        _loc7_ = b2PolygonContact.s_evalCP;
        ...
        if (this.m_manifold.pointCount > 0) {
            ...
            while (_loc8_ < this.m_manifold.pointCount) {
                _loc10_ = this.m_manifold.points[_loc8_];
                ...
                while (_loc13_ < this.m0.pointCount) {
                    if (_loc9_[_loc13_] != true) {
                        ...
                        if (_loc4_.id._key == _loc12_) {
                            ...
                            _loc11_ = true;
                            if (param1 != null) {
                                _loc7_.position = _loc5_.GetWorldPoint(
                                    _loc10_.localPoint1,
                                );
