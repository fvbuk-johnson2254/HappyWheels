...
export default class b2ContactSolver {
    public m_step = new b2TimeStep();
    public m_allocator;
    public m_constraints: any[];
    public m_constraintCount: number;

    constructor(param1: b2TimeStep, param2: any[], param3: number, param4) {
        ...
        while (_loc6_ < param3) {
            _loc5_ = param2[_loc6_];
            _loc10_ = _loc5_.m_shape1.m_body;
            ...
            while (_loc22_ < _loc12_) {
                _loc23_ = _loc13_[_loc22_];
                _loc24_ = _loc23_.normal.x;
                _loc25_ = _loc23_.normal.y;
                _loc26_ = this.m_constraints[_loc9_];
                _loc26_.body1 = _loc10_;
                ...
                while (_loc27_ < _loc26_.pointCount) {
                    ...
                    _loc29_ = _loc26_.points[_loc27_];
                    _loc29_.normalImpulse = _loc28_.normalImpulse;
                    ...
                    _loc32_ =
                        _loc28_.localPoint1.x - _loc10_.m_sweep.localCenter.x;
                    _loc33_ =
                        _loc28_.localPoint1.y - _loc10_.m_sweep.localCenter.y;
                    ...
                    _loc34_ =
                        _loc28_.localPoint2.x - _loc11_.m_sweep.localCenter.x;
                    _loc35_ =
                        _loc28_.localPoint2.y - _loc11_.m_sweep.localCenter.y;
                    ...
                    _loc40_ = _loc10_.m_invMass + _loc11_.m_invMass;
                    _loc40_ =
                        _loc40_ +
                        (_loc10_.m_invI * (_loc36_ - _loc38_ * _loc38_) +
                            _loc11_.m_invI * (_loc37_ - _loc39_ * _loc39_));
                    _loc29_.normalMass = 1 / _loc40_;
                    _loc41_ =
                        _loc10_.m_mass * _loc10_.m_invMass +
                        _loc11_.m_mass * _loc11_.m_invMass;
                    _loc41_ =
                        _loc41_ +
                        (_loc10_.m_mass *
                            _loc10_.m_invI *
                            (_loc36_ - _loc38_ * _loc38_) +
                            _loc11_.m_mass *
                            _loc11_.m_invI *
                            (_loc37_ - _loc39_ * _loc39_));
                    _loc29_.equalizedMass = 1 / _loc41_;
                    _loc42_ = _loc25_;
                    _loc43_ = -_loc24_;
                    _loc44_ = _loc32_ * _loc42_ + _loc33_ * _loc43_;
                    _loc45_ = _loc34_ * _loc42_ + _loc35_ * _loc43_;
                    _loc46_ = _loc10_.m_invMass + _loc11_.m_invMass;
                    _loc46_ =
                        _loc46_ +
                        (_loc10_.m_invI * (_loc36_ - _loc44_ * _loc44_) +
                            _loc11_.m_invI * (_loc37_ - _loc45_ * _loc45_));
                    ...
                    _loc31_ =
                        ...
                        _loc20_ * _loc32_;
                    _loc47_ =
                        _loc26_.normal.x * _loc30_ + _loc26_.normal.y * _loc31_;
    ...
    public InitVelocityConstraints(param1: b2TimeStep) {
        ...
        while (_loc5_ < this.m_constraintCount) {
            _loc6_ = this.m_constraints[_loc5_];
            _loc7_ = _loc6_.body1;
            _loc8_ = _loc6_.body2;
            ...
            if (param1.warmStarting) {
                ...
                while (_loc18_ < _loc19_) {
                    ...
                    _loc21_ =
                        _loc20_.normalImpulse * _loc13_ +
                        _loc20_.tangentImpulse * _loc15_;
                    _loc22_ =
                        _loc20_.normalImpulse * _loc14_ +
                        _loc20_.tangentImpulse * _loc16_;
                    _loc7_.m_angularVelocity -=
                        _loc10_ *
                        (_loc20_.r1.x * _loc22_ - _loc20_.r1.y * _loc21_);
                    _loc7_.m_linearVelocity.x -= _loc9_ * _loc21_;
                    _loc7_.m_linearVelocity.y -= _loc9_ * _loc22_;
                    _loc8_.m_angularVelocity +=
                        _loc12_ *
                        (_loc20_.r2.x * _loc22_ - _loc20_.r2.y * _loc21_);
    ...
    public SolveVelocityConstraints() {
        ...
        while (_loc19_ < this.m_constraintCount) {
            _loc20_ = this.m_constraints[_loc19_];
            _loc21_ = _loc20_.body1;
            ...
            while (_loc1_ < _loc37_) {
                ...
                _loc14_ = b2Math.b2Clamp(
                    _loc2_.tangentImpulse + _loc12_,
                    -_loc38_,
                    _loc38_,
                );
                ...
                _loc23_ -=
                    _loc28_ * (_loc2_.r1.x * _loc16_ - _loc2_.r1.y * _loc15_);
                _loc26_.x += _loc29_ * _loc15_;
                _loc26_.y += _loc29_ * _loc16_;
                _loc24_ +=
                    _loc30_ * (_loc2_.r2.x * _loc16_ - _loc2_.r2.y * _loc15_);
    ...
    public SolvePositionConstraints(param1: number): boolean {
        ...
        while (_loc5_ < this.m_constraintCount) {
            ...
            while (_loc20_ < _loc19_) {
                ...
                _loc33_ =
                    _loc31_ * _loc17_ + _loc32_ * _loc18_ + _loc21_.separation;
                _loc2_ = b2Math.b2Min(_loc2_, _loc33_);
                _loc34_ =
                    param1 *
                    b2Math.b2Clamp(
                        _loc33_ + b2Settings.b2_linearSlop,
                ...
                _loc35_ = _loc21_.positionImpulse - _loc36_;
                _loc37_ = _loc35_ * _loc17_;
