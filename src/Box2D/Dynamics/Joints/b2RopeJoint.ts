...
export default class b2RopeJoint extends b2Joint {
    ...
    constructor(param1: b2RopeJointDef) {
        super(param1);
        ...
        this.m_length = 0;
        this.m_maxLength = param1.length;
        this.m_impulse = 0;
        this.m_inv_dt = 0;
    }
    ...
    public override InitVelocityConstraints(param1: b2TimeStep) {
        ...
        if (this.m_length > b2Settings.b2_linearSlop) {
            ...
            if (param1.warmStarting) {
                ...
                _loc14_ = this.m_impulse * this.m_u.x;
                _loc15_ = this.m_impulse * this.m_u.y;
                _loc4_.m_linearVelocity.x -= _loc4_.m_invMass * _loc14_;
                _loc4_.m_linearVelocity.y -= _loc4_.m_invMass * _loc15_;
                _loc4_.m_angularVelocity -=
                    _loc4_.m_invI * (_loc6_ * _loc15_ - _loc7_ * _loc14_);
                _loc5_.m_linearVelocity.x += _loc5_.m_invMass * _loc14_;
                _loc5_.m_linearVelocity.y += _loc5_.m_invMass * _loc15_;
                _loc5_.m_angularVelocity +=
                    _loc5_.m_invI * (_loc8_ * _loc15_ - _loc9_ * _loc14_);
            } else {
                this.m_impulse = 0;
            }
            return;
    ...
    public override SolveVelocityConstraints(param1: b2TimeStep) {
        ...
        var _loc15_: number = this.m_length - this.m_maxLength;
        if (_loc15_ < 0) {
            _loc14_ += param1.inv_dt * _loc15_;
        }
        var _loc16_: number = -this.m_mass * _loc14_;
        var _loc17_: number = this.m_impulse;
        this.m_impulse = Math.min(0, this.m_impulse + _loc16_);
        _loc16_ = this.m_impulse - _loc17_;
        var _loc18_: number = _loc16_ * this.m_u.x;
        var _loc19_: number = _loc16_ * this.m_u.y;
        _loc3_.m_linearVelocity.x -= _loc3_.m_invMass * _loc18_;
        _loc3_.m_linearVelocity.y -= _loc3_.m_invMass * _loc19_;
        _loc3_.m_angularVelocity -=
            _loc3_.m_invI * (_loc5_ * _loc19_ - _loc6_ * _loc18_);
        _loc4_.m_linearVelocity.x += _loc4_.m_invMass * _loc18_;
        _loc4_.m_linearVelocity.y += _loc4_.m_invMass * _loc19_;
        _loc4_.m_angularVelocity +=
            _loc4_.m_invI * (_loc8_ * _loc19_ - _loc9_ * _loc18_);
    }
    ...
    public override SolvePositionConstraints(): boolean {
        ...
        _loc9_ /= _loc11_;
        _loc10_ /= _loc11_;
        var _loc12_: number = _loc11_ - this.m_maxLength;
        _loc12_ = b2Math.b2Clamp(_loc12_, 0, b2Settings.b2_maxLinearCorrection);
        ...
        return _loc11_ - this.m_maxLength < b2Settings.b2_linearSlop;
    }
